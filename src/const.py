...
LOWER_SPENDING_THRESHOLD = 0 # if a player's balance is under this threshold,
# they will attempt to sell/mortgage until they're above it. When a player is
# eliminated and their?????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????

UPPER_SPENDING_THRESHOLD = 0 # if a player's balance is under this threshold,
