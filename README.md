...
- Si es troben per sobre del límit o bé exactament al límit, gastaràn el que puguin, fins que baixin dels $40 o no puguin gastar.
...
#### Funcions del joc
- **`main.py`** és el programa principal, que executa.
- **`tile.py`** conté:
